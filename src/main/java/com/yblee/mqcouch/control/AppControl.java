	...
	private boolean initCouchDBInstance(int timeout) {
		...
		try {
			if(AppModel.SERVER_COUCH_USER.isEmpty() || AppModel.SERVER_COUCH_PASS.isEmpty()) {
				...
				System.out.println("=========== couch user : " + (AppModel.SERVER_COUCH_USER.isEmpty()?"Empty":"Not Empty"));
				System.out.println("=========== couch pass : " + (AppModel.SERVER_COUCH_PASS.isEmpty()?"Empty":"Not Empty"));
